        ...
        <div class="row">
            <div class="col-lg-4 col-sm-7">
                <div class="footer_item">
                    <h4>About Company</h4>
                    <img class="logo" src="Vistas/Componentes/images/logo.png" alt="Construction" />
...
<!-- JavaScript -->
<script src="Vistas/Componentes/js/jquery-1.12.1.min.js"></script>
<script src="Vistas/Componentes/js/bootstrap.min.js"></script>

<!-- Bootsnav js -->
<script src="Vistas/Componentes/js/bootsnav.js"></script>

<!-- JS Implementing Plugins -->
<script src="Vistas/Componentes/js/isotope.js"></script>
<script src="Vistas/Componentes/js/isotope-active.js"></script>
<script src="Vistas/Componentes/js/jquery.fancybox.js?v=2.1.5"></script>

<script src="Vistas/Componentes/js/jquery.scrollUp.min.js"></script>

<script src="Vistas/Componentes/js/main.js"></script>
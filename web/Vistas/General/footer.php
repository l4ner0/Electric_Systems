            ...
            <div class="col-lg-3 col-sm-5">
                <div class="footer_item">
                    ...
                    <ul class="list-unstyled footer_menu">
                        <li><a href="inicio"><span class="fa fa-play"></span> Inicio</a>
                        <li><a href="#about"><span class="fa fa-play"></span> ¿Quiénes somos?</a>
                        <li><a href="#services"><span class="fa fa-play"></span> Nuestros Servicios</a>
                        <li><a href="#portfolio"><span class="fa fa-play"></span> Nuestros Productos</a>
                    </ul>
                </div>
            </div>
